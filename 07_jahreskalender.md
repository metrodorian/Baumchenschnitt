...
- **§ 39 BNatSchG:** Radikalschnitte (auf den Stock setzen, Rodung, starker Rückschnitt) nur **1. Oktober – 28. Februar**. Schonende **Form- und Pflegeschnitte sind ganzjährig erlaubt** — unsere Sommer-Niwaki-Pflege fällt darunter.
- **Brutzeit (März–September):** Vor jedem Schnitt auf Nester prüfen. Besetztes Nest = dieser Bereich bleibt unangetastet, bis die Brut ausgeflogen ist.
- **Kommunale Baumschutzsatzung:** Manche Gemeinden schützen Bäume ab einem bestimmten Stammumfang (oft 60–80 cm in 1 m Höhe). Für *Pflegeschnitte* meist unkritisch, aber bei größeren Eingriffen einmal die örtliche Satzung prüfen.

## Merksätze

> **Sommer hält klein, Winter macht groß.**

> **Ableiten statt kappen — immer.**
